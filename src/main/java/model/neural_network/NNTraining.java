...
public class NNTraining {
    final static int generations = 50;//number of generations to train
    final static int guardType = 2;
    ...
    final static String mapPath = "src/main/resources/maps/phase2_3.txt";//map to be used if your not training on all 3 maps
